"""Test structlog with logging-based formatters (render_to_log_kwargs) - OPTIMISED."""
...
# - Use orjson for faster JSON serialization (though still goes through stdlib)
# - Cache logger on first use
# Note: This still uses stdlib integration, but optimizes what we can
structlog.configure(
